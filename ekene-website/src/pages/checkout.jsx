...
export function Checkout({ cart = [], setCart }) {
  ...
  const handleDelete = (cartItemId) => {
    axios.delete(`http://localhost:5000/cart/${cartItemId}`)
      .then(() => axios.get('http://localhost:5000/cart'))
  ...
  // UPDATED: Now uses customerDetails.email
  const handlePlaceOrder = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/paystack/init", {
        email: customerDetails.email, // DYNAMIC EMAIL FROM FORM
        amount: orderTotal,
          ...
          <div className="order-summary">
            <div className="shipping-form-container">
              ...
              <div className="shipping-grid">
                ...
                {/* UPDATED: Added Email Input Field */}
